...
sendWSMessage <- function(conn, binary, message) {
	invisible(.Call(`_httpuv2_sendWSMessage`, conn, binary, message))
}

closeWS <- function(conn, code, reason) {
	invisible(.Call(`_httpuv2_closeWS`, conn, code, reason))
}
...
makeTcpServer <- function(host, port, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet) {
	.Call(`_httpuv2_makeTcpServer`, host, port, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet)
}
...
makePipeServer <- function(name, mask, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet) {
	.Call(`_httpuv2_makePipeServer`, name, mask, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet)
}

stopServer_ <- function(handle) {
	invisible(.Call(`_httpuv2_stopServer_`, handle))
}

getStaticPaths_ <- function(handle) {
	.Call(`_httpuv2_getStaticPaths_`, handle)
}

setStaticPaths_ <- function(handle, sp) {
	.Call(`_httpuv2_setStaticPaths_`, handle, sp)
}

removeStaticPaths_ <- function(handle, paths) {
	.Call(`_httpuv2_removeStaticPaths_`, handle, paths)
}

getStaticPathOptions_ <- function(handle) {
	.Call(`_httpuv2_getStaticPathOptions_`, handle)
}

setStaticPathOptions_ <- function(handle, opts) {
	.Call(`_httpuv2_setStaticPathOptions_`, handle, opts)
}

base64encode <- function(x) {
	.Call(`_httpuv2_base64encode`, x)
}
...
encodeURI <- function(value) {
	.Call(`_httpuv2_encodeURI`, value)
}

#' @rdname encodeURI
#' @export
encodeURIComponent <- function(value) {
	.Call(`_httpuv2_encodeURIComponent`, value)
}

#' @rdname encodeURI
#' @export
decodeURI <- function(value) {
	.Call(`_httpuv2_decodeURI`, value)
}

#' @rdname encodeURI
#' @export
decodeURIComponent <- function(value) {
	.Call(`_httpuv2_decodeURIComponent`, value)
}
...
ipFamily <- function(ip) {
	.Call(`_httpuv2_ipFamily`, ip)
}

invokeCppCallback <- function(data, callback_xptr) {
	invisible(.Call(`_httpuv2_invokeCppCallback`, data, callback_xptr))
}
...
getRNGState <- function() {
	invisible(.Call(`_httpuv2_getRNGState`))
}

wsconn_address <- function(external_ptr) {
	.Call(`_httpuv2_wsconn_address`, external_ptr)
}

log_level <- function(level) {
	.Call(`_httpuv2_log_level`, level)
}
